            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="tp-service-2-item p-relative mb-30 wow fadeInUp" data-wow-duration="1s"
                        ...
                        <div class="tp-service-2-inner">
                            <h4 class="tp-service-title"><a href="service.detail.html">House Cleaning</a></h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="tp-service-2-item p-relative mb-30 wow fadeInUp" data-wow-duration="1s"
                        ...
                        <div class="tp-service-2-inner">
                            <h4 class="tp-service-title"><a href="service-detail.html">Office Cleaning</a></h4>
                            <p>It was popularised in the with the recently with software.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="tp-service-2-item p-relative mb-30 wow fadeInUp" data-wow-duration="1s"
                        ...
                        <div class="tp-service-2-inner">
                            <h4 class="tp-service-title"><a href="service-detail.html">Window Cleaning</a></h4>
                            <p>It was popularised in the with the recently with software.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="tp-service-2-item p-relative mb-30 wow fadeInUp" data-wow-duration="1s"
                        ...
                        <div class="tp-service-2-inner">
                            <h4 class="tp-service-title"><a href="service-detail.html">Floore Cleaning</a></h4>
                            <p>It was popularised in the with the recently with software.</p>
                        </div>
                    </div>
                </div>
