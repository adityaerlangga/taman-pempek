...
<footer class="tp-footer-area p-relative">
    <div class="tp-footer-wrapper" data-background="home-assets/img/footer/footer-bg-1.jpg">
       <div class="tp-footer-overlay"></div>
       <div class="tp-footer-shape">
          <img class="shape-1" src="home-assets/img/footer/shape-1.png" alt="">
          <img class="shape-2" src="home-assets/img/footer/shape-2.png" alt="">
       </div>
          ...
          <div class="tp-footer-logo-area pt-100 pb-75">
            <div class="tp-footer-logo-content p-relative">
             <div class="tp-footer-logo-content-shape d-none d-xl-block">
                <img class="shape-3" src="home-assets/img/footer/shape-3.png" alt="">
                <img class="shape-4" src="home-assets/img/footer/shape-4.png" alt="">
             </div>
             <div class="row align-items-center">
                <div class="col-md-4 col-lg-6">
                   <div class="tp-footer-logo">
                      <a href="index.html">
                         <img src="home-assets/img/footer/footer-logo.png" alt="">
                      </a>
                   </div>
                </div>
...
<!-- JS here -->
<script src="/home-assets/js/vendor/jquery.js"></script>
<script src="/home-assets/js/vendor/waypoints.js"></script>
...
<script src="/home-assets/js/splide.js"></script>
...
<script src="/home-assets/js/jquery.knob.js"></script>
<script src="/home-assets/js/circularProgressBar.min.js"></script>
